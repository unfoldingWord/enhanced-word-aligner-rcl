...
export const DEFAULT_MAX_COMPLEXITY = 200000; // initial complexity threshold for alignment suggestion training, used to prevent training from taking too long as well as memory overflow
