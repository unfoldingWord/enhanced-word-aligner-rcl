...
export const DEFAULT_MAX_COMPLEXITY = 300000; // initial complexity threshold for alignment suggestion training
export const MAX_COMPLEXITY = 1000000; // maximum complexity threshold for alignment suggestion training
export const MIN_COMPLEXITY = 1000; // minimum complexity threshold for alignment suggestion training
