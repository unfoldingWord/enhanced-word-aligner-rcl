...
export const WORKER_TIMEOUT_MINUTES = 10; // maximum runtime for training worker in minutes
export const MIN_THRESHOLD_TRAINING_MINUTES = 6; // minimum threshold training time in minutes
export const WORKER_TIMEOUT = WORKER_TIMEOUT_MINUTES * 60 * 1000; // maximum runtime for training worker in milliseconds
